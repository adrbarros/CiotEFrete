...
namespace CiotEFrete.WebService
{
    public static class CertificadoDigital
    {
        ...
        /// <param name="senha">Senha do certificado digital</param>
        /// <returns></returns>
        public static X509Certificate2 ObterDoArrayBytes(byte[] arrayBytes, string senha)
        {
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        public static X509Certificate2 ObterDoRepositorio(string serial, OpenFlags opcoesDeAbertura)
        {
        ...
        /// <returns></returns>
        public static X509Certificate2 ObterDoRepositorioPassandoPin(string serial, string senha = null)
        {
