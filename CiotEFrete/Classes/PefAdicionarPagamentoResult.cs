...
{
    public sealed class PefAdicionarPagamentoResult : INotifyPropertyChanged
    {
        #region Eventos
        ...
        [DFeElement(TipoCampo.Int, "QuantidadeDePagamentos", Ocorrencia = Ocorrencia.Obrigatoria, Ordem = 3)]
