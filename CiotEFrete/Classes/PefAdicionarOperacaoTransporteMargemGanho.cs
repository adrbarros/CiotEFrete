...
namespace CiotEFrete.Classes
{
    ...
    public sealed class PefAdicionarOperacaoTransporteMargemGanho : INotifyPropertyChanged
    {
        #region Eventos
        ...
        public string TipoProxy
        {
            get
            {
                switch (Tipo)
                {
                    ...
                    default: throw new NotImplementedException("Tipo de margem de ganho não implementado");
                }
            }
