...
{
    public sealed class PefAdicionarOperacaoTransporteResult : INotifyPropertyChanged
    {
        #region Eventos
        ...
        [DFeElement(TipoCampo.Str, "ProtocoloServico", Namespace = "http://schemas.ipc.adm.br/efrete/objects", Ocorrencia = Ocorrencia.Obrigatoria, Ordem = 5)]
